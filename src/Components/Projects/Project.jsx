            ...
            <div class="col-sm-12 col-md-12 col-lg-6">
              ...
              <div className="kmg-folio-text-2">
                <p>
                  ...
                  appealing multi-stage portfolio project. Feel free to explore
        ...
        <div class="col-sm-12 col-md-12 col-lg-10">
          <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6">
              ...
              <div className="kmg-folio-text-2">
                <p>
                  I enhanced the Smart Home App with features that improved user
                  experience and significantly boosted conversion rates for
            ...
            <div class="col-sm-12 col-md-12 col-lg-6">
              ...
              <div className="kmg-folio-text-2">
                <p>
                  ...
                  making it easy to explore articles and authors while keeping a
        ...
        <div class="col-sm-12 col-md-12 col-lg-10">
          <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6">
              ...
              <div className="kmg-folio-text-2">
                <p>
                  SidonPay is a result of my creative vision—a sleek, multi-step
                  portfolio project designed for speed and visual impact.
                </p>
              </div>
              <div className="conta">
                <Button />
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-6">
              <div className="aboutmecont">
                ...
                <div className="kmg-folio-text-23">
                  <p>
                    These are my go-to tools for designing clean, user-friendly,
